import JaxBash from "../assets/img-projects/jax-and-bash.png";
import AstroPortfolio from "../assets/img-projects/astro-portfolio.png";

export const projects = [
  {
    title: "Jax & Bash Foundation Website",
    description:
      "Custom WordPress website for a non-profit organization, featuring a responsive design and easy content management using ACF and Gutenberg blocks.",
    image: JaxBash.src,
    technologies: ["WordPress", "PHP", "Bootstrap Grid", "Blocks", "ACF"],
    demo: "https://jaxandbashfoundation.org/",
    code: "https://github.com/jessrodier/jax-bash-foundation",
    category: "wordpress",
  },
  {
    title: "Portfolio Website",
    description:
      "Personal portfolio built with Astro and React, showcasing projects and skills with a modern, responsive design.",
    image: AstroPortfolio.src,
    technologies: ["Astro", "React", "javascript"],
    demo: "https://jessrodier.com/",
    code: "https://github.com/jessrodier/astro-portfolio",
    category: "other",
  },
  // {
  ...
  //   demo: "https://projecto-final-rodriguez-sable.vercel.app/",
  //   code: "https://github.com/Lautaro-R-collins/projectoFinal-Rodriguez.git",
  //   category: "fullstack",
  // },
  // {
  ...
  //   code: "https://github.com/Lautaro-R-collins/Portfolio-developers-astro.git",
  //   category: "frontend",
  // },
